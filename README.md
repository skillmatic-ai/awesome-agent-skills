...
- [knot0-com/vibe-testing](https://github.com/knot0-com/vibe-testing) - Pressure-test spec documents with LLM reasoning before writing code. Traces scenarios step-by-step against specs to find gaps, conflicts, and ambiguities.
