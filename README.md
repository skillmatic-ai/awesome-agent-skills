...
- [EmblemCompany/Agent-skills](https://github.com/EmblemCompany/Agent-skills) - Crypto wallet management across 7 blockchains (Solana, Ethereum, Base, BSC, Polygon, Hedera, Bitcoin) via EmblemAI.
